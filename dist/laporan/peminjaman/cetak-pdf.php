...
session_start();
    ...
    $pdf->Cell(38,6,'Anggota',1,0,'C');
    $pdf->Cell(65,6,'Pustaka',1,0,'C');
    $pdf->Cell(21,6,'Tgl Pinjam',1,0,'C');
    $pdf->Cell(21,6,'Tgl Kembali',1,0,'C');
    ...
    while ($data = mysqli_fetch_array($hasil)):
        ...
        $pdf->Cell(7,6,$no,1,0);
        $pdf->Cell(13,6,$data['kode_peminjaman'],1,0);
        $pdf->Cell(38,6,substr($data['nama_anggota'],0,17),1,0);
        $pdf->Cell(65,6,substr($data['judul_pustaka'],0,39),1,0);
        $pdf->Cell(21,6,$tanggal_pinjam,1,0);
        $pdf->Cell(21,6,$tanggal_kembali,1,0);
    ...
    $pdf->Cell(340,0,'Mengetahui Ketua',0,1,'C');
