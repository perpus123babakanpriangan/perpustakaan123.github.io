    ...
    <div id="tabel_denda">           
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td>
                    <div class="form-group">
                        <input type="text" class="form-control" id="biaya_hilang_kerusakan" name="biaya_hilang_kerusakan" value="<?php if ($_POST['jenis_denda']=='2') echo $_POST['denda']; ?> " placeholder="Masukan biaya" disabled>  
                    </div>
                    <div class="form-group">
