                                ...
                                <table class="table table-striped table-bordered">
                                    ...
                                    <?php
                                        ...
                                        if ($ambil['tanggal_pinjam']=='0000-00-00'){
                                            ...
                                            $tanggal_pinjam=date("d/m/Y",strtotime($ambil['tanggal_pinjam']));
                                        }
                                        if ($ambil['tanggal_kembali']=='0000-00-00'){
                                            $tanggal_kembali="";
                                        }else {
                                            $tanggal_kembali=date("d/m/Y",strtotime($ambil['tanggal_kembali']));
                                        }
...
<script>
    ...
    $('.tombol_konfirmasi').on('click',function(){
        ...
        $.ajax({
            ...
            method: 'post',
            data: {id_detail_peminjaman:id_detail_peminjaman,kode_peminjaman:kode_peminjaman,kode_pustaka:kode_pustaka,tanggal_pinjam:tanggal_pinjam,status:status,jenis_denda:jenis_denda,denda:denda},
            success:function(data){
                $('#tampil_data').html(data);  
