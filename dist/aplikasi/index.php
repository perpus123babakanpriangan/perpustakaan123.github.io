                        ...
                        <!-- Card Header - Dropdown -->
                            ...
                            <div class="card-body">
                                <form action="aplikasi/edit.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label>Estimasi waktu Peminjaman: <span id="info_waktu_pinjam"><?php echo $data['waktu_peminjaman'];?> hari</span> </label>
                                        <input type="text" class="form-control" id="waktu_peminjaman" value="<?php echo $data['waktu_peminjaman'];?>" name="waktu_peminjaman" required>  
                                    </div>
                                    <div class="form-group">
                                        <label>Maksimal Peminjaman: <span id="info_maksimal_pinjam"><?php echo $data['maksimal_peminjaman'];?> Pustaka</span> </label>
                                        <input type="text" class="form-control" id="maksimal_pinjam" value="<?php echo $data['maksimal_peminjaman'];?>" name="maksimal_peminjaman" required>  
                                    </div>
                                    <div class="form-group">
                                        <label>Besaran Denda Keterlambatan: <span id="info_denda_terlambat">Rp. <?php echo number_format($data['denda_keterlambatan'],0,',','.'); ?>/hari</span> </label>
                                        <input type="text" class="form-control" id="denda_terlambat" value="<?php echo $data['denda_keterlambatan'];?>" name="denda_keterlambatan" required>  
                                    </div>
                                    <div class="form-group">
